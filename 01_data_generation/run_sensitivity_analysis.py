...
if __name__ == "__main__":
    ...
    print("Enter number of jobs. Enter -1 if you want to use all available threads.")
    response = int(input())
    if response == -1:
        n_jobs = cpu_count()
    ...
    if generate_new_samples:
        ...
        ) = readMCparameters(output_dir / "MC_parameter.csv")
    ...
    try:
        ...
        processes = run_grid(grid_table, processes, run_model_file, "Nominal", n_jobs)
        ...
        for i in range(n_samples):
            ...
            processes = run_grid(grid_table, processes, run_model_file, i, n_jobs)
