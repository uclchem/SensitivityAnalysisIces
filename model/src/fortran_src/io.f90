MODULE IO
    ...
    CHARACTER (LEN=500) :: abundSaveFile, abundLoadFile, outputFile, rateFile, columnFile, outFile
...
CONTAINS
    ...
    SUBROUTINE output(returnArray,successflag,physicsarray, chemicalabunarray, dtime, timepoints)
        REAL(dp), DIMENSION(:, :, :), OPTIONAL :: physicsarray
        REAL(dp), DIMENSION(:, :, :), OPTIONAL :: chemicalabunarray
