...
CONTAINS
    ...
    SUBROUTINE initializePhysics(successFlag)
        ...
        ! derived as:
        a1=6.0
        at=(1/zmax)*((maxTemp-initialTemp)*(exp(a1)-1.))**(1./6.)
    ...
    SUBROUTINE updatePhysics
        ...
        tn(dstep)=initialTemp+((at*zn)**bt)/(exp(zn/z3)-1)
        ...
        ! tgr1=8.9d-11*nu0*G0*exp(1.8*av(dstep))+2.7**5
